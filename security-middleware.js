...
export const corsMiddleware = cors({
    origin: process.env.ALLOWED_ORIGINS ? 
        ...
        ['https://la-reina.onrender.com', 'http://localhost:3000'],
...
export const validateFileUpload = (req, res, next) => {
    if (!req.file) {
        // Si no hay archivo, continuar (podría ser solo URL)
        return next();
    }
    ...
    // Verificar que sea realmente una imagen (magic numbers)
...
// 10. TOKEN CSRF (para formularios)
