...
// ============================================================
// 🔒 CONFIGURACIÓN DE SEGURIDAD - SOLO VARIABLES DE ENTORNO
// ============================================================
...
if (!ENV.ADMIN_PASSWORD) ENV_ERRORS.push('❌ ADMIN_PASSWORD no está configurada - ¡ESTO ES CRÍTICO!');
...
if (ENV_ERRORS.length > 0) {
    ...
    if (ENV.NODE_ENV === 'production') {
        ...
        console.error('🚫 Por favor, configura ADMIN_PASSWORD en las variables de entorno de Render.');
        process.exit(1);
    } else {
...
// ============================================================
// 🚨 RUTAS ESTÁTICAS - SIRVEN index.html y admin.html
// ============================================================
...
// ============================================================
// 12. LOGIN ADMIN - SEGURO (SOLO VARIABLE DE ENTORNO)
// ============================================================
...
app.post('/api/admin/login', (req, res) => {
    ...
    console.log(`🔐 ADMIN_PASSWORD: ${ENV.ADMIN_PASSWORD ? '✅ Configurada' : '❌ NO CONFIGURADA'}`);
    console.log('🔐 =======================================');
    ...
    if (password.trim() === ENV.ADMIN_PASSWORD.trim()) {
...
// ============================================================
// 18. RUTAS ADMIN - CONFIGURACIÓN (CORREGIDA)
// ============================================================
...
app.get('/api/admin/config', async (req, res) => {
    try {
        ...
        // ✅ Asegurar que siempre devuelva el formato correcto
        res.json({
            id: data.id,
...
app.put('/api/admin/config', [
    ...
    try {
        ...
        // ✅ Construir objeto de tasas correctamente
        const tasas = { 
            CUP: 1, 
