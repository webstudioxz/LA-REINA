...
// ============================================
// VARIABLES DE ENTORNO - SOLO DESDE ENTORNO
// ============================================
const SUPABASE_URL = process.env.SUPABASE_URL;
const SUPABASE_SERVICE_ROLE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY;
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD;

// Validación crítica - NUNCA hardcodear
if (!ADMIN_PASSWORD) {
...
// ============================================
// 🛡️ BLOQUEO DE RUTAS SOSPECHOSAS (CORREGIDO)
// ============================================
app.use((req, res, next) => {
    const blockedPaths = [
        '/login', '/wp-admin', '/cpanel',  // <-- QUITADO /admin
...
// ============================================
// RUTAS DE AUTENTICACIÓN - CON DIAGNÓSTICO COMPLETO
// ============================================
app.post('/api/admin/login', (req, res) => {
    ...
    console.log(`🔐 Longitud recibida: ${password ? password.length : 0}`);
    console.log(`🔐 ADMIN_PASSWORD desde env: "${ADMIN_PASSWORD}"`);
    console.log(`🔐 Longitud real: ${ADMIN_PASSWORD ? ADMIN_PASSWORD.length : 0}`);
    console.log(`🔐 Comparación exacta: ${password === ADMIN_PASSWORD ? '✅ COINCIDE' : '❌ NO COINCIDE'}`);
    console.log(`🔐 Comparación trim: ${password?.trim() === ADMIN_PASSWORD?.trim() ? '✅ COINCIDE' : '❌ NO COINCIDE'}`);
    console.log('🔐 ==========================================');
    ...
    // Comparación con trim para evitar espacios accidentales
...
app.get('/admin', (req, res) => res.sendFile(path.join(__dirname, 'admin.html')));  // <-- NUEVA RUTA
app.get('/admin.html', (req, res) => res.redirect('/admin'));  // <-- REDIRECCIÓN
...
// ============================================
// API ADMIN (TODAS PROTEGIDAS POR requireAuth)
// ============================================
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`🔐 Admin password: ${ADMIN_PASSWORD ? '✅ Configurada en variables de entorno' : '❌ No configurada'}`);
    ...
    console.log(`📋 Panel Admin: https://la-reina.onrender.com/admin`);
});