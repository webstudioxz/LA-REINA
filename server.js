...
// ============================================
// 🛡️ BLOQUEO DE RUTAS SOSPECHOSAS - SEGURIDAD
// ============================================
app.use((req, res, next) => {
    // Lista de rutas comúnmente atacadas
    const blockedPaths = [
        '/login',
        '/admin', 
        '/wp-admin', 
    ...
    // Verificar si la ruta solicitada está en la lista de bloqueo
    const requestPath = req.path.toLowerCase();
    if (blockedPaths.some(path => requestPath.startsWith(path))) {
        console.log(`🔴 [BLOQUEADO] Acceso a ${req.path} desde ${req.ip} (${req.get('user-agent') || 'desconocido'})`);
...
// ============================================
// APLICAR AUTENTICACIÓN A RUTAS ADMIN
// ============================================
app.use('/api/admin', requireAuth);

// ============================================
// RUTAS DE AUTENTICACIÓN (PÚBLICAS PERO CON VALIDACIÓN)
// ============================================
