...
console.log(`🔍 ADMIN_PASSWORD longitud: ${ADMIN_PASSWORD ? ADMIN_PASSWORD.length : 0}`);
console.log('🔍 =================================');
...
// ============================================
// LOGIN - CON SEGURIDAD PERO SIN SANITIZACIÓN
// ============================================
app.post('/api/admin/login', (req, res) => {
    ...
    console.log(`🔐 Longitud: ${password ? password.length : 0}`);
    console.log(`🔐 ADMIN_PASSWORD: "${ADMIN_PASSWORD}"`);
    console.log(`🔐 Longitud env: ${ADMIN_PASSWORD ? ADMIN_PASSWORD.length : 0}`);
