...
const ENV = {
    ...
    ADMIN_PASSWORD: process.env.ADMIN_PASSWORD, // ⚠️ SOLO DESDE VARIABLE DE ENTORNO
...
// ============================================================
// 7. BLOQUEO DE RUTAS MALICIOSAS (CORREGIDO - SIN /config)
// ============================================================
...
app.post('/api/admin/login', (req, res) => {
    ...
    // ⚠️ LOG SEGURO - NO MUESTRA LA CONTRASEÑA
    ...
    // Comparación segura (trim para evitar espacios)
