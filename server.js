...
app.post('/api/admin/login', bruteForceProtection.check, async (req, res) => {
    ...
    console.log(`🔐 Password esperada: ${ADMIN_PASSWORD ? '***' : 'NO CONFIGURADA'}`);
    console.log('🔐 ============================');
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`🔑 JWT Secret: ${JWT_SECRET ? '✅ Generado' : '❌ No generado'}`);
    ...
    console.log(`📦 Sesiones con JWT: ✅ Activado`);
