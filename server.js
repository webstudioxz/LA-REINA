...
// ============================================
app.get('/api/admin/verify-session', requireAuth, (req, res) => res.json({ valid: true }));
...
app.post('/api/admin/productos', requireAuth, upload.array('imagenes', 10), validateProduct, async (req, res) => {
    try {
...
app.put('/api/admin/productos/:id', requireAuth, upload.array('imagenes', 10), validateProduct, async (req, res) => {
    try {
