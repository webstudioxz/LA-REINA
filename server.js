...
// Cargar variables de entorno desde .env (fallback)
dotenv.config();
...
// ¡NUNCA imprimas el valor real de la contraseña en los logs!
...
if (!ADMIN_PASSWORD) {
    ...
    console.error('❌ Por favor, configura ADMIN_PASSWORD en Render o en .env');
    process.exit(1);
}
...
const requireAuth = (req, res, next) => {
    ...
    // Verificar contraseña directa (fallback para compatibilidad)
    ...
    // Si no hay autenticación, denegar
...
app.post('/api/admin/login', (req, res) => {
    ...
    // Usar comparación segura de contraseñas
    if (password === ADMIN_PASSWORD) {
        ...
        console.log(`🔴 Intento de login fallido desde ${req.ip}`);
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`📋 Variables de entorno cargadas: ${process.env.NODE_ENV === 'production' ? '🟢 Producción' : '🟡 Desarrollo'}`);
});